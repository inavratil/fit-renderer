...
bool GeometryMaterial::BakeMaterial(int light_count, int dpshadow_method, bool use_pcf)
{
    ...
    string vert_vars = 
		"//-- GLSL vertex shader generated by gluxEngine\n";			//-- Vertex shader variables
	string vert_func = 
		SG_NEWLINE+SG_LONG_DELIM+"\n//-- Vertex shader functions\n\n";	//-- Vertex shader functions
	string vert_main = 
		SG_NEWLINE+SG_LONG_DELIM+SG_NEWLINE+"\nvoid main()\n{\n";		//-- Vertex shader main function
    ...
    for(m_it_textures = m_textures.begin(); m_it_textures != m_textures.end(); ++m_it_textures)
    {
		...
		if(m_it_textures->second->GetType() == SHADOW)
        {
            ...
            vert_main += "  " + m_it_textures->first + "_projShadow = " + m_it_textures->first + "_texMatrix * "+SG_V4_VERTCOORD+";   //calculate shadow texture projection\n";
        }
...
////////////////////////////////////////////////////////////////////////////////
	...
	string frag_vars = 
		"//-- GLSL fragment shader generated by gluxEngine\n";			//-- Shader variables
	string frag_func = 
