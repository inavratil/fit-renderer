...
void TCamera::setFreelookCamera(glm::vec3 vPos, glm::vec3 vUp, glm::vec3 vFocusPoint)
{
	m_pos = vPos;
	m_up = vUp;
...
void TCamera::handleInputMessage(cam_events e)
{
	switch(e)
	{
...
void TCamera::adjustOrientation(float p, float y)
{
	pitch += p;
	yaw += y;
