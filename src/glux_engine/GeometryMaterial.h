...
public:
    //material creation
	GeometryMaterial( const char* _name );
    GeometryMaterial(const char* name, int id, glm::vec3 amb, glm::vec3 diff, glm::vec3 spec, 
...
typedef GeometryMaterial* GeometryMaterialPtr;
